...
<body>
  ...
  <header class="header-with-background" style="background-image: url('<?php echo $headerImg; ?>');">
    ...
    <nav>
      <a 
      <?php if (!empty($pageKey) && $pageKey === "our-mission"): ?> class="active" <?php endif; ?> 
      href="our-mission.php">Our mission</a>

      <a 
      <?php if (!empty($pageKey) && $pageKey === "ingredients"): ?> class="active" <?php endif; ?> 
      href="ingredients.php">Ingredients</a>

      <a
      <?php if (!empty($pageKey) && $pageKey === "menu"): ?> class="active" <?php endif; ?> 
